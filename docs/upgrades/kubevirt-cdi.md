...
- **Aktuelle Version:** KubeVirt v1.9.0 | CDI v1.66.1
...
| 2026-09-13 | CDI v1.66.0 → v1.66.1, KubeVirt bleibt v1.9.0 | Patch | Manuell (kustomization.yaml Release-URL) | Abgeschlossen | Reiner Bugfix-Patch: qemu-Fix für gescheiterten Import auf 4k-Block-Devices, nbdkit-nfc-Support für vSphere-Disk-Imports (nicht genutzt), Mindestgrößen-Fix für HPE-XP/Hitachi-HSPC-Provisioner (nicht genutzt). Kein Breaking Change | Teil der Sammel-Update-Runde 2026-09-13 (zusammen mit cert-manager, kube-prometheus-stack, sealed-secrets, traefik); CDI-Phase nach Sync `Deployed`, alle CDI-Pods sauber neu hochgelaufen, windows-ad-VM unberührt |
